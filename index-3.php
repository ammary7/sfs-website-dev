...
<html lang="en-US" class="no-js">
 ...
 <?php include 'includes/conn.php'; ?>
    ...
    />
    <link rel="stylesheet" href="css/news-and-events-slider.css" /> -->
    <!-- End News & Events Section -->

    <!-- Success Stories 1 Section -->

    <link rel="stylesheet" href="css/success-stories-1-slider.css" />

    <!-- End Success Stories 1 Section -->

    <!-- Success Stories 3 Section -->

    <!-- <link rel="stylesheet" href="css/success-stories-3-slider.css" /> -->

    <!-- End Success Stories 3 Section -->

    <!-- Success Stories Section -->

    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"><link rel="stylesheet" href="css/success-stories-slider.css">
    ...
    <link
      href="https://fonts.googleapis.com/css?family=Playfair+Display:700%2C400"
      rel="stylesheet"
      property="stylesheet"
      type="text/css"
      media="all"
    ...
    <link rel="stylesheet" href="css/news-and-events-2-slider.css">
    

    <!-- End Success Stories 4 Section -->
              ...
              >
                <ul id="menu-main-navigation" class="m-menu">
                  ...
                  >
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item menu-item-home">
                        <a href="accounts/login.php">Homepage 1</a>
                      </li>
                      <li class="menu-item">
                  ...
                  <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item">
                        <a href="about-us.html">About KU</a>
                      </li>
                      <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="menu-item">
                            <a href="school-of-law.html">School Of Law</a>
                          </li>
                          <li class="menu-item">
                          ...
                          <li class="menu-item">
                            <a href="art-science.html">Art &#038; Science</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          <li class="menu-item">
                            <a href="hospitality-management.html"
                      ...
                      <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="menu-item">
                            <a href="john-hagensy-phd.html"
                              >Single Instructor</a
                            >
                          </li>
                          <li class="menu-item">
                            <a href="introduction-to-financial-accounting.html"
                              >Single Course</a
                            >
                          </li>
                        </ul>
                  ...
                  <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item">
                        <a href="apply-to-kingster.html">Apply To Kingster</a>
                      </li>
                      <li class="menu-item">
                        <a href="campus-tour.html">Campus Tour</a>
                      </li>
                      <li class="menu-item">
                      ...
                      <li class="menu-item">
                        <a href="give-to-kingster.html">Give To Kingster</a>
                      </li>
                      <li class="menu-item">
                  ...
                  <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item">
                        <a href="course-list-1.html">Course List 1</a>
                      </li>
                      <li class="menu-item">
                        <a href="course-list-2.html">Course List 2</a>
                      </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                  ...
                  <li class="menu-item">
                    <a href="university-life.html">University Life</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="kingster-top-bar-container kingster-container">
            <div class="kingster-top-bar-container-inner clearfix">
              <div class="kingster-top-bar-left kingster-item-pdlr">
                ...
                sfs@gmail.com
                <i class="fa fa-phone" id="i_fd84_1"></i> +1-3435-2356-222
              </div>
              ...
              <div class="kingster-navigation kingster-item-pdlr clearfix">
                <div class="kingster-main-menu" id="kingster-main-menu">
                  <ul id="menu-main-navigation-1" class="sf-menu">
                          ...
                          <ul class="sub-menu">
                            <li class="menu-item menu-item-has-children">
                              ...
                              <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                  <a
                                    href="blog-full-left-sidebar-with-frame.html"
                                    >Blog Full Left Sidebar With Frame</a
                                  >
                                </li>
                                <li class="menu-item">
                                  <a
                                    href="blog-full-both-sidebar-with-frame.html"
                                    >Blog Full Both Sidebar With Frame</a
                                  >
                                </li>
                                <li class="menu-item">
                    ...
                    <li
                      class="menu-item menu-item-has-children kingster-mega-menu"
                    >
                      <a
                        href="bachelor-of-science-in-business-administration.html"
                        class="sf-with-ul-pre"
                        ...
                        <ul class="sub-menu">
                          ...
                          >
                            ...
                            <ul class="sub-menu">
                              ...
                              <li class="menu-item">
                                <a
                                  href="introduction-to-financial-accounting.html"
                                  >Single Course</a
                                >
                              </li>
                            </ul>
                    ...
                    <li
                      class="menu-item menu-item-has-children kingster-normal-menu"
                    >
                      <a href="apply-to-kingster.html" class="sf-with-ul-pre"
                        >Admissions</a
                      >
                      <ul class="sub-menu">
                        <li class="menu-item" data-size="60">
                    ...
                    <li
                      class="menu-item menu-item-has-children kingster-normal-menu"
                    >
                      <a href="#" class="sf-with-ul-pre">Courses</a>
                      <ul class="sub-menu">
                        <li class="menu-item" data-size="60">
                          <a href="course-list-1.html">Course List 1</a>
                        </li>
                      ...
                      >
                        ...
                        >
                          <ul>
						       ...
						       <?php
		  $conn = $pdo->open();
							$stmt = $conn->prepare("SELECT * from news where category_id = 11 order by id DESC LIMIT 6 ");
						    $stmt->execute();
						    foreach ($stmt as $row) {
$image = (!empty($row['photo'])) ? 'accounts/images/'.$row['photo'] : 'images/noimage.jpg';
							?>  
                            ...
                            <li
                              ...
                              data-thumb="upload/slider-1-2-100x50.jpg"
                              data-rotate="0"
      ...
      <div class="row ftco-animate justify-content-center">
        <div class="col-md-12">
          <div class="carousel-testimony owl-carousel">
                                 ...
                                 <?php
		  $conn = $pdo->open();
							$stmt = $conn->prepare("SELECT * from news where category_id = 13 || category_id = 12 order by id DESC LIMIT 6");
						    $stmt->execute();
						    foreach ($stmt as $row) {
$image = (!empty($row['photo'])) ? 'accounts/images/'.$row['photo'] : 'images/noimage.jpg';
							?>  
            ...
            <div class="item">
              <div class="testimony-wrap d-flex">
                <div class="news-card">
                  ...
                  <img src="<?php echo $image; ?>" alt="" class="news-card__image">
                  <div class="news-card__text-wrapper">
                    <h2 class="news-card__title"><?php echo $row['name']; ?></h2>
                    <div class="news-card__post-date"><?php echo $row['date_view']; ?></div>
                    <div class="news-card__details-wrapper">
                      <p class="news-card__excerpt">  <p> <?php  echo substr($row['description'], 0,350);?></p></p>
    ...
    <!-- </section> -->
                          ...
                          >
                            ...
                            >
                              <p>
                                ...
                                discover a field they’re passionate about and
                                dare to lead it.
                              </p>
                            </div>
                          </div>
            ...
            <div class="slider" id="slider" style="--img-prev:url(https://images.pexels.com/photos/3807755/pexels-photo-3807755.jpeg?auto=compress&cs=tinysrgb&h=766&w=1600);"> 
              <div class="slider__content" id="slider-content">
                <div class="slider__images">
                  <div class="slider__images-item slider__images-item--active" data-id="1"><img src="https://images.pexels.com/photos/3807755/pexels-photo-3807755.jpeg?auto=compress&cs=tinysrgb&h=766&w=1600"/></div>
                  <div class="slider__images-item" data-id="2"><img src="https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg?auto=compress&cs=tinysrgb&h=766&w=1600"/></div>
                  <div class="slider__images-item" data-id="3"><img src="https://images.pexels.com/photos/1462630/pexels-photo-1462630.jpeg?auto=compress&cs=tinysrgb&h=766&w=1600"/></div>
                ...
                <div class="slider__text">
                  ...
                  <div class="slider__text-item slider__text-item--active" data-id="1">            
                    ...
                    <div class="slider__text-item-info">
                      <p>“SFS played a vital role in getting me to a Med School”</p>
                    </div>
                  </div>
                  ...
                  <div class="slider__text-item" data-id="2">
                    ...
                    <div class="slider__text-item-info">
                      <p>“SFS played a vital role in my Software Engineering Career</p>
                    </div>
                  </div>
                  <div class="slider__text-item" data-id="3">
                    ...
                    <div class="slider__text-item-info">
                      <p>“SFS played a vital role in getting me to a Law School”</p>
                    </div>
                  </div>
		  ...
		  $conn = $pdo->open();
							$stmt = $conn->prepare("SELECT * from news where category_id = 14 order by id DESC LIMIT 6");
						    $stmt->execute();
						    foreach ($stmt as $row) {
$image = (!empty($row['photo'])) ? 'accounts/images/'.$row['photo'] : 'images/noimage.jpg';
					?>    
							  <div class="item">
                                ...
                                <div class="testimony-wrap d-flex">
                                  <div class="user-img mr-4" style="background-image: url(<?php echo $image ?>)">
                                  </div>
                                  <div class="text ml-2">
...
$image = (!empty($row['photo'])) ? 'accounts/images/'.$row['photo'] : 'images/noimage.jpg';
                          ...
                          <div class="col-md-12">
                              <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center"> -->
                                  ...
                                  <!-- <div class="carousel-inner">
                                      <div class="carousel-item active"> <img src="images/news-bg-1.jpg" alt="Hills"> </div>
                                      <div class="carousel-item"> <img src="images/news-bg-2.jpg" alt="Hills"> </div>
                                      <div class="carousel-item"> <img src="images/news-bg-3.jpg" alt="Hills"> </div>
                                      <div class="carousel-item"> <img src="images/news-bg-1.jpg" alt="Hills"> </div>
                                  </div> -->
                                   <!-- Left right --> 
                                  <!-- <a class="carousel-control-prev" href="#custCarousel" data-slide="prev">  </a> <a class="carousel-control-next" href="#custCarousel" data-slide="next"> </span> </a> -->
                                   <!-- Thumbnails -->
                                  <!-- <ol class="carousel-indicators list-inline">
                                      <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#custCarousel"> <img src="images/news-bg-1.jpg" class="img-fluid"> </a> </li>
                                      <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#custCarousel"> <img src="images/news-bg-2.jpg" class="img-fluid"> </a> </li>
                                      <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="2" data-target="#custCarousel"> <img src="images/news-bg-3.jpg" class="img-fluid"> </a> </li>
                                      <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="3" data-target="#custCarousel"> <img src="images/news-bg-1.jpg" class="img-fluid"> </a> </li>
                                  </ol>
                              </div>
                          </div>
                      </div>
                ...
                >
                      ...
                      >
                        <div class="gdlr-core-pbf-element">
                          ...
                          >
                            ...
                            >
                              <div
                                class="gdlr-core-block-item-title-inner clearfix"
                              >
                                <h3
                              ...
                              <a
                                class="gdlr-core-block-item-read-more"
                                href="#"
                                target="_self"
                                id="a_1dd7_5"
                                >Read All News</a
                            ...
                            >
                              <div
                                class="gdlr-core-item-list-wrap gdlr-core-column-30"
                              >
                                <div
                                  class="gdlr-core-item-list-inner gdlr-core-item-mglr"
                                >
                                  <div class="gdlr-core-blog-grid">
                                    ...
                                    >
                                      <a href="#">
                                        <img
                                          src="upload/shutterstock_135948689-400x245.jpg"
                                          width="700"
                                          height="430"
                                          alt=""
                                        />
                                    ...
                                    <div
                                      class="gdlr-core-blog-grid-content-wrap"
                                    >
                                      <div
                                      ...
                                      >
                                        <a href="#"
                                          >Professor Albert joint research on
                                          mobile money in Tanzania</a
                                        >
                                      </h3>
                                    </div>
                                  </div>
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <a href="#">
                                      <img
                                        src="upload/shutterstock_218235004-150x150.jpg"
                                        alt=""
                                        width="150"
                                        height="150"
                                        title="Student"
                                  ...
                                  <div class="gdlr-core-blog-widget-content">
                                    ...
                                    >
                                      <a href="#"
                                        >A Global MBA for the next generation of
                                        business leaders</a
                                      >
                                    </h3>
                                  </div>
                                ...
                                >
                                  ...
                                  >
                                    <a href="#">
                                      <img
                                        src="upload/shutterstock_481869205-150x150.jpg"
                                        alt=""
                                        width="150"
                                        height="150"
                                        title="shutterstock_481869205"
                                      />
                                    </a>
                                  </div>
                                  <div class="gdlr-core-blog-widget-content">
                                ...
                                >
                                  ...
                                  >
                                    <a href="#">
                                      <img
                                        src="upload/shutterstock_361397258-150x150.jpg"
                                        alt=""
                                        width="150"
                                        height="150"
                                        title="shutterstock_361397258"
                                      />
                                    </a>
                                  </div>
                                  <div class="gdlr-core-blog-widget-content">
                                    ...
                                    >
                                      <a href="#"
                                        >Professor Alexa is interviewed about
                    ...
                    >
                      ...
                      >
                          ...
                          >
                            ...
                            >
                              <h3
                                ...
                                id="h3_1dd7_16"
                              >
                                <a href="#" target="_self">Alumni & Donors</a>
                              </h3>
                            </div>
                          </div>
                        </div>
                          ...
                          >
                            ...
                            >
                              <h3
                                ...
                                id="h3_1dd7_17"
                              >
                                <a href="#" target="_self">Athletic Calendar</a>
                              </h3>
                            </div>
                          </div>
                        </div>
                          ...
                          >
                            ...
                            >
                              <h3
                                ...
                                id="h3_1dd7_20"
                              >
                                <a href="#" target="_self">Academic Programs</a>
                              </h3>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="gdlr-core-pbf-element">
                          <div
                            class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr"
                            id="gdlr-core-title-item-id-33183"
                          >
                            <div
                              class="gdlr-core-title-item-title-wrap clearfix"
                            >
                              <h3
                                ...
                                id="h3_1dd7_21"
                              >
                                <a href="#" target="_self">Tution And Fees</a>
                              </h3>
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        <div class="gdlr-core-pbf-element">
                          ...
                          >
                            ...
                            >
                              <div
                                class="gdlr-core-twitter-item gdlr-core-item-pdb"
                                id="div_1dd7_67"
                              >
                                <div class="gdlr-core-block-item-title-nav">
                                  <div
                                    class="gdlr-core-flexslider-nav gdlr-core-plain-style gdlr-core-block-center"
                                  ></div>
                                </div>
                                  ...
                                  >
                                    <ul class="slides" id="ul_1dd7_0">
                                      <li class="gdlr-core-item-mglr">
                                        <div
                                          class="gdlr-core-twitter-item-list"
                                        >
                                          <span
                                            class="gdlr-core-twitter-item-list-content"
                                            >Shaking off the working week!
                                            What&#8217;s on the agenda for the
                                            weekend? by KonstantinKolosov via…
                                            <a
                                              target="_blank"
                                              href="https://t.co/fSyxq53H6P"
                                              >https://t.co/fSyxq53H6P</a
                                            >
                                          </span>
                                          <span
                                            class="gdlr-core-twitter-item-list-date gdlr-core-skin-caption"
                                          >
                                            <a
                                              class="gdlr-core-twitter-date"
                                      ...
                                      <li class="gdlr-core-item-mglr">
                                        ...
                                        >
                                          <span
                                            ...
                                            >RT
                                            <a
                                              href="http://www.twitter.com/placeitapp"
                                              >@placeitapp</a
                                            >: Making a
                                            <a
                                              target="_blank"
                                              href="http://twitter.com/search?q=YouTube"
                                              >#YouTube</a
                                            >
                                            banner for your channel is easy with
                                            Placeit&#8217;s
                                            <a
                                              target="_blank"
                                              href="http://twitter.com/search?q=bannermaker!"
                                              >#bannermaker!</a
                                            >
                                            Make your own in sec…
                                            <a
                                              target="_blank"
                                              href="https://t.co/0X22tX3wtm"
                                              >https://t.co/0X22tX3wtm</a
                                            >
                                          </span>
                                          <span
                                            class="gdlr-core-twitter-item-list-date gdlr-core-skin-caption"
                                          >
                                            <a
                                              class="gdlr-core-twitter-date"
                                              href="http://twitter.com/Envato/statuses/1030338474891792385"
                                              target="_blank"
                                            >
                                              yesterday</a
                                            >
                                      ...
                                      <li class="gdlr-core-item-mglr">
                                        ...
                                        >
                                          <span
                                            ...
                                            <a
                                              href="http://www.twitter.com/MRidsdale16"
                                              >@MRidsdale16</a
                                            >
                                            joined
                                            <a
                                              href="http://www.twitter.com/benjaminlaw"
                                              >@benjaminlaw</a
                                            >
                                            and
                                            <a
                                              href="http://www.twitter.com/raejohnston"
                                              >@raejohnston</a
                                            >
                                            on
                                            <a
                                              href="http://www.twitter.com/tsushow"
                                              >@tsushow</a
                                            >
                                            to discuss all things Cultu…
                                            <a
                                              target="_blank"
                                              href="https://t.co/uszxz0qicU"
                                              >https://t.co/uszxz0qicU</a
                                            >
                                          </span>
                                          <span
                                            class="gdlr-core-twitter-item-list-date gdlr-core-skin-caption"
                                          >
                                            <a
                                              class="gdlr-core-twitter-date"
                                              href="http://twitter.com/Envato/statuses/1029988653282541570"
                                              target="_blank"
                                            >
                                              2 days ago</a
                                            >
                  ...
                  >
                    ...
                    >
                      ...
                      <a
                        class="gdlr-core-pbf-column-link"
                        href="#"
                        target="_self"
                      ></a>
                    </div>
                    ...
                    >
                      ...
                      >
                        <a
                          ...
                          href="https://www.youtube.com/watch?v=C5pKtnmHTxg"
                          ><img
                            src="upload/icon-play.png"
                            alt=""
                            width="82"
                            height="82"
                            title="icon-play"
                      ...
                      <div class="gdlr-core-tab-item-wrap">
                        ...
                        <div class="gdlr-core-tab-item-content-wrap clearfix">
                          ...
                          >
                            ...
                            <p>
                              Kingster University was established by John Smith
                              in 1920 for the public benefit and it is
                              recognized globally. Throughout our great history,
                              Kingster has offered access to a wide range of
                              academic opportunities. As a world leader in
                              higher education, the University has pioneered
                ...
                >
                  ...
                  >
                    <div
                      class="gdlr-core-pbf-column-content-margin gdlr-core-js"
                      id="div_1dd7_82"
                      data-sync-height="height-column"
                      data-sync-height-center
                    >
                      <div class="gdlr-core-pbf-background-wrap">
                        <div
                      ...
                      >
                        <div class="gdlr-core-pbf-element">
                          ...
                          >
                            ...
                            >
                              <img
                                src="upload/hp-donation-400x212.jpg"
                                width="700"
                                height="372"
                                alt=""
                              />
                            ...
                            <div class="gdlr-core-event-item-holder clearfix">
                              ...
                              >
                                ...
                                <div class="gdlr-core-event-item-content-wrap">
                                  <h3 class="gdlr-core-event-item-title">
                                    <a href="#"
                                      >Reunion Event : Kingster’s Alumni Golf
                                      Tour</a
                                    >
                                  </h3>
                              ...
                              >
                                ...
                                <div class="gdlr-core-event-item-content-wrap">
                                  <h3 class="gdlr-core-event-item-title">
                                    <a href="#"
                                      >Kingster’s Alumni Hot Air Ballon Trip in
                                      Turkey</a
                                    >
                                  </h3>
                                  <div class="gdlr-core-event-item-info-wrap">
                        ...
                        <div class="gdlr-core-pbf-element">
                          ...
                          >
                            ...
                            <span
                              class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption"
                              id="span_1dd7_9"
                              >Get updates to news & events</span
                            >
                          </div>
                        </div>
                        <div class="gdlr-core-pbf-element">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="gdlr-core-pbf-element">
                          ...
                          >
                            <form
                              class="gdlr-core-course-form clearfix"
                              action="#"
                              method="GET"
                            >
                              <div
                              ...
                              <div
                                class="gdlr-core-course-column gdlr-core-column-30"
                              >
                                <div
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <select
                                      class="gdlr-core-skin-e-content"
                                      name="department"
                                    >
                                      <option value="">Department</option>
                                      <option value="business-adminstration"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <option value="admans-hall"
                                        >Adman's Hall</option
                                      >
                                      <option value="kingsters-80"
                                        >Kingster's 80</option
                                      >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <option value="albert-coman-phd"
                                        >Albert Coman (PhD)</option
                                      >
                                      <option value="angelina-jones-phd"
                                        >Angelina Jones (PhD)</option
                                      >
                                      <option value="bruce-willis-phd"
                                        >Bruce Willis (PhD)</option
                                      >
                                      <option value="carol-dawson-phd"
                                        >Carol Dawson (PhD)</option
                                      >
                                      <option value="john-hagensy"
                                        >John Hagensy (PhD)</option
                                      >
                                    </select>
                                  </div>
                                </div>
        ...
        <div class="em">
          ...
          <ul>
            <li>
              <a href="https://en.wikipedia.org/wiki/Education#">Wikipedia</a>
            </li>
            <li>
              <a href="https://www.theidioms.com/#title">Theidioms.com</a>
            </li>
            <li>
              <a href="https://www.britannica.com/topic/English-language#"
                >English language</a
              >
            </li>
              ...
              >
                <div id="text-2" class="widget widget_text kingster-widget">
                  <div class="textwidget">
                    <p>
                      <img src="upload/footer-logo.png" alt="" /> <br />
                      <span
                      ...
                      144, <br />
                      Jalkheri Street, <br />
                      Seattle, WA 98104-2648.
                    </p>
                    <p>
                      <span id="span_1dd7_11">+1-2534-4456-345</span> <br />
                      <span
                        class="gdlr-core-space-shortcode"
                        id="span_1dd7_12"
                      ></span>
          ...
          <div class="kingster-copyright-wrapper">
            ...
            >
              <div class="kingster-copyright-left kingster-item-pdlr">
                Copyright All Right Reserved 2020, SFS
              </div>
    ...
    <script src="js/news-and-events.js"></script> -->
    <!-- End News & Events Section -->

    <!-- Success Stories 1 Section -->

    <script src="js/success-stories-1-slider.js"></script>
          ...
          if (tpj('#rev_slider_1_1').revolution == undefined) {
            ...
            revapi1 = tpj('#rev_slider_1_1')
              ...
              .revolution({
                sliderType: 'standard',
                jsFileLocation:
                  '//demo.goodlayers.com/kingster/wp-content/plugins/revslider/public/assets/js/',
                sliderLayout: 'auto',
                dottedOverlay: 'none',
                delay: 9000,
                navigation: {
